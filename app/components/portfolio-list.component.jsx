...
const PortfolioList = ({ portfolio }) => {
  const webItems = portfolio.filter(filterPortfolioByProp('isWebsite')).map(item => <PortfolioItem item={item} key={item.ID} />);
  const designItems = portfolio.filter(filterPortfolioByProp('isDesign')).map(item => <PortfolioItem item={item} key={item.ID} />);
  const otherItems = portfolio.filter(filterPortfolioByProp('isOther')).map(item => <PortfolioItem item={item} key={item.ID} />);
