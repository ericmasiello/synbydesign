...
import filter, { addMetaData } from './transform-portfolio-json.util';
...
describe('Transform Portfolio JSON Utility', () => {
  ...
  it('should set default alt text if not defined', () => {
    const mockData = mockWebPortfolio[0];
